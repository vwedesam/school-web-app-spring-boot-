...
public interface CoursesRepository extends JpaRepository<Courses, Integer> {
    ...
    /**
     * Spring Data JPA allows us to apply static sorting by adding the OrderBy keyword to the method name
     * along with the property name and sort direction (Asc or Desc).
     * @return
     */
