...
INSERT INTO `holidays` (`day`, `reason`, `type`, `created_at`, `created_by`)
VALUES (' May 30 ', 'SamVwede"s Day', 'FEDERAL', CURDATE(), 'DBA');
...
INSERT INTO `person` (`name`,`email`,`mobile_number`,`pwd`,`role_id`,`created_at`, `created_by`)
  VALUES ('Admin','admin2@eazyschool.com','3443434343','$2a$10$XhU4UcSxDPb5G0I0fT/CZ.Lfj2VW2fkLkUP5cOEM.xM8EzyUQXaD2', 1 ,CURDATE(),'DBA');
